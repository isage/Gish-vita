...
void createtarboy(float position[3])
{
  ...
  for (count = 0; count < 16; count++)
  {
    ...
    createbond(object[numofobjects].particle[((count + 8) & 15)], object[numofobjects].particle[(count & 15)], 2,
               numofobjects);
  }
  copyvector(object[numofobjects].position, position);
...
void createwheel(float position[3], float sizex, float sizey, float mass, float friction, int anchor)
{
  ...
  for (count = 0; count < 16; count++)
  {
    createbond(object[numofobjects].particle[((count + 1) & 15)], object[numofobjects].particle[(count & 15)], 1,
               numofobjects);
    createbond(object[numofobjects].particle[((count + 2) & 15)], object[numofobjects].particle[(count & 15)], 1,
               numofobjects);
    createbond(object[numofobjects].particle[((count + 3) & 15)], object[numofobjects].particle[(count & 15)], 1,
               numofobjects);
