...
void gamedisplay(void)
  ...
  if (game.levelnum==1)
    ...
    if (!game.playreplay) {
      ...
      drawkeybitmap((526|TEXT_CENTER),(YtxtButtonRow2|TEXT_CENTER),12,12,control[0].key[KEYALIAS_LEFT],keyhighlight,keyhighlight2);
      drawkeybitmap((536|TEXT_CENTER),(YtxtButtonRow3|TEXT_CENTER),12,12,control[0].key[KEYALIAS_DOWN],keyhighlight,keyhighlight2);
      drawkeybitmap((546|TEXT_CENTER),(YtxtButtonRow2|TEXT_CENTER),12,12,control[0].key[KEYALIAS_RIGHT],keyhighlight,keyhighlight2);
