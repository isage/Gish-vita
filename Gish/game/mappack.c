...
void mappackpostgamemenu(void)
{
  ...
  while (!menuitem[0].active && !menuitem[1].active && !windowinfo.shutdown)
  {
    ...
    drawtext(TXT_LEVEL_POINTS ":/i", 64, 368, 16, 1.0f, 1.0f, 1.0f, 1.0f,
             game.score[0] - (object[0].hitpoints / 50) * 10);

    drawtext(TXT_TOTAL_POINTS ":/i", 64, 384, 16, 1.0f, 1.0f, 1.0f, 1.0f, scoretemp);
    drawtext("+/i", 64 + 19 * 16, 384, 16, 1.0f, 1.0f, 1.0f, 1.0f,
             game.score[0] - (scoretemp - playermappack[playernum].totalscore));
...
void mappackpregamemenu(void)
{
  ...
  while (!menuitem[0].active && !windowinfo.shutdown)
  {
    ...
    drawtext(mappack.levelname[playermappack[playernum].levelnum - 1], (320 | TEXT_CENTER), 256, 16, 1.0f, 1.0f, 1.0f,
             1.0f);
    drawtext(TXT_LIVES " /i", (320 | TEXT_CENTER), 272, 16, 1.0f, 1.0f, 1.0f, 1.0f,
             playermappack[playernum].numoflives);
    drawtext(TXT_POINTS " /i", (320 | TEXT_CENTER), 288, 16, 1.0f, 1.0f, 1.0f, 1.0f,
             playermappack[playernum].totalscore);
...
void mappackendingmenu(void)
{
  ...
  while (!menuitem[0].active && !windowinfo.shutdown)
  {
    ...
    drawtext(TXT_TOTAL_POINTS ":/i", (320 | TEXT_CENTER), 448, 16, 1.0f, 1.0f, 1.0f, 1.0f,
             playermappack[playernum].totalscore);
