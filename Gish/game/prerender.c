        ...
        if (fabs(vec[0]) - object[count].radius < view.zoom)
          if (fabs(vec[1]) - object[count].radius < view.zoom)
          {
            ...
            if (object[count].texturenum == 58)
              objectrender[numofobjectrenders].texturenum
                  = 256 + object[count].texturenum + 1 + (game.framenum / 7) % 5;
            else
      ...
      if (object[count].type == 10)
      {
        ...
        if (fabs(vec[0]) - object[count].radius < view.zoom)
          if (fabs(vec[1]) - object[count].radius < view.zoom)
          {
            ...
            for (count2 = 0; count2 < 4; count2++)
            {
              copyvector(objectrender[numofobjectrenders].vertex[count2],
                         particle[object[count].particle[count2]].position);
            ...
            for (count2 = 0; count2 < 4; count2++)
            {
              normal[0] = -(particle[object[count].particle[((count2 + 1) & 3)]].position[1]
                            - particle[object[count].particle[count2]].position[1]);
              normal[1] = (particle[object[count].particle[((count2 + 1) & 3)]].position[0]
                           - particle[object[count].particle[count2]].position[0]);
              normal[2] = 0.0f;
              ...
              copyvector(objectrender[numofobjectrenders].edgevertex[count2][0],
                         particle[object[count].particle[count2]].position);
              copyvector(objectrender[numofobjectrenders].edgevertex[count2][1],
                         particle[object[count].particle[((count2 + 1) & 3)]].position);
              ...
              objectrender[numofobjectrenders].edgetexcoord[count2][1][0]
                  = object[count].texcoord[((count2 + 1) & 3)][0];
              objectrender[numofobjectrenders].edgetexcoord[count2][1][1]
                  = object[count].texcoord[((count2 + 1) & 3)][1];
              objectrender[numofobjectrenders].edgetexcoord[count2][2][0]
                  = object[count].texcoord[((count2 + 1) & 3)][0] + normal[0];
              objectrender[numofobjectrenders].edgetexcoord[count2][2][1]
                  = object[count].texcoord[((count2 + 1) & 3)][1] + normal[1];
              objectrender[numofobjectrenders].edgetexcoord[count2][3][0]
                  = object[count].texcoord[count2][0] + normal[0];
              objectrender[numofobjectrenders].edgetexcoord[count2][3][1]
                  = object[count].texcoord[count2][1] + normal[1];
            }
          ...
          if (fabs(vec[1]) - object[count].radius < view.zoom)
          {
            ...
            for (count2 = 0; count2 < 16; count2++)
            {
              if (!object[count].particlestick[count2])
                copyvector(objectrender[numofobjectrenders].vertex[count2 * 2 + 0],
                           particle[object[count].particle[count2]].position);
              else
                copyvector(objectrender[numofobjectrenders].vertex[count2 * 2 + 0],
                           object[count].particlestickposition[count2]);
            }
            for (count2 = 0; count2 < 16; count2++)
            {
              addvectors(vec, objectrender[numofobjectrenders].vertex[count2 * 2 + 0],
                         objectrender[numofobjectrenders].vertex[((count2 + 1) & 15) * 2 + 0]);
              addvectors(vec2, objectrender[numofobjectrenders].vertex[((count2 - 1) & 15) * 2 + 0],
                         objectrender[numofobjectrenders].vertex[((count2 + 2) & 15) * 2 + 0]);
            ...
            */
            ...
            {
              vec[0] = objectrender[numofobjectrenders].vertex[((count2 - 1) & 31)][1]
                       - objectrender[numofobjectrenders].vertex[((count2 + 0) & 31)][1];
              vec[1] = objectrender[numofobjectrenders].vertex[((count2 + 0) & 31)][0]
                       - objectrender[numofobjectrenders].vertex[((count2 - 1) & 31)][0];
              vec[2]  = 0.0f;
              vec2[0] = objectrender[numofobjectrenders].vertex[((count2 + 0) & 31)][1]
                        - objectrender[numofobjectrenders].vertex[((count2 + 1) & 31)][1];
              vec2[1] = objectrender[numofobjectrenders].vertex[((count2 + 1) & 31)][0]
                        - objectrender[numofobjectrenders].vertex[((count2 + 0) & 31)][0];
              vec2[2] = 0.0f;
          ...
          if (fabs(vec[1]) - object[count].radius < view.zoom)
          {
            ...
            for (count2 = 0; count2 < 4; count2++)
            {
              ...
              if (object[count].beasttype == 12)
              {
                if (count2 == 0)
                {
                  subtractvectors(vec, particle[object[count].particle[0]].position,
                                  particle[object[count].particle[3]].position);
                  addvectors(vec, particle[object[count].particle[0]].position, vec);
                  subtractvectors(vec, vec, object[count].position);
                }
                if (count2 == 1)
                {
                  subtractvectors(vec, particle[object[count].particle[1]].position,
                                  particle[object[count].particle[2]].position);
              ...
              if ((object[count].direction == 0 && (count2 == 0 || count2 == 3))
                  || (object[count].direction == 1 && (count2 == 1 || count2 == 2)))
                objectrender[numofobjectrenders].texcoord[count2][0] = 0.0f;
              else
                objectrender[numofobjectrenders].texcoord[count2][0] = 1.0f;
              if (count2 < 2)
      ...
      if (fabs(vec[0]) - 4.0f < view.zoom)
        if (fabs(vec[1]) - 4.0f < view.zoom)
        {
          ...
          for (count2 = 0; count2 < 4; count2++)
          {
            ...
            if ((boss[count].direction == 0 && (count2 == 0 || count2 == 3))
                || (boss[count].direction == 1 && (count2 == 1 || count2 == 2)))
              objectrender[numofobjectrenders].texcoord[count2][0] = 0.0f;
            else
              objectrender[numofobjectrenders].texcoord[count2][0] = 1.0f;
            if (count2 < 2)
    ...
    if (rope[count].texturenum != 0)
    {
      ...
      if (fabs(vec[0]) - scale < view.zoom)
        if (fabs(vec[1]) - scale < view.zoom)
        {
          ...
          objectrender[numofobjectrenders].numofverts = 4;
          count2                                      = 0;
          subtractvectors(objectrender[numofobjectrenders].vertex[count2], particle[rope[count].part1].position,
                          normal);
          objectrender[numofobjectrenders].texcoord[count2][0] = 0.0f;
          objectrender[numofobjectrenders].texcoord[count2][1] = 0.0f;
          count2                                               = 1;
          ...
          objectrender[numofobjectrenders].texcoord[count2][1] = 1.0f;
          count2                                               = 3;
          subtractvectors(objectrender[numofobjectrenders].vertex[count2], particle[rope[count].part2].position,
                          normal);
          objectrender[numofobjectrenders].texcoord[count2][0] = 0.0f;
          objectrender[numofobjectrenders].texcoord[count2][1] = 1.0f;
