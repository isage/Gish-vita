    ...
    if (object[count].type == 4)
    {
      ...
      if (object[count].animationtype == 2)
      {
        ...
        if (object[count].frame == 1)
          if (object[count].framedelay == 0.0f)
          {
            if (object[count].beasttype < 3 || object[count].beasttype == 8 || object[count].beasttype == 11
                || object[count].beasttype == 16)
        ...
        if (object[count].frame == 5)
        {
          // if (object[count].beasttype!=7 && object[count].beasttype!=13)
          {
            ...
            if (lineintersectobject(intersectpoint, normal, &scale, object[count].position, vec, 0, particlelist))
            {
              ...
              if (object[count].direction == 0)
              {
                scaleaddvectors(particle[particlelist[0]].velocity, particle[particlelist[0]].velocity,
                                object[count].orientation[0], -scale);
                scaleaddvectors(particle[particlelist[1]].velocity, particle[particlelist[1]].velocity,
                                object[count].orientation[0], -scale);
              }
              if (object[count].direction == 1)
              {
...
void loadanimations(void)
{
  ...
  if (animation[count2].loaded == 2)
  {
    ...
    for (count = 1; count <= animation[count2].stand[1]; count++)
    {
      ...
      loadtexturetga_anim(numofanimations, filename, 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
      numofanimations++;
    }
  ...
  if (animation[count2].loaded == 2)
  {
    ...
    animation[count2].stand[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "mumhed01.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].walk[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "mumhed02.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].attack[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "mumhed03.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].stand[1] = numofanimations;
    loadtexturetga_anim(numofanimations, "mumhed05.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].die[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "mumhed06.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;
  }
  ...
  if (animation[count2].loaded == 2)
  {
    ...
    animation[count2].stand[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "sklhed01.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].walk[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "sklhed02.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].attack[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "sklhed03.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].stand[1] = numofanimations;
    loadtexturetga_anim(numofanimations, "sklhed05.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].die[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "sklhed06.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;
  }
  ...
  if (animation[count2].loaded == 2)
  {
    ...
    animation[count2].stand[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "zomhed01.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].walk[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "zomhed02.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].attack[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "zomhed03.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].stand[1] = numofanimations;
    loadtexturetga_anim(numofanimations, "zomhed05.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].die[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "zomhed06.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;
  }
  ...
  if (animation[count2].loaded == 2)
  {
    ...
    animation[count2].stand[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "gimhed01.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].walk[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "gimhed02.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].attack[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "gimhed03.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].stand[1] = numofanimations;
    loadtexturetga_anim(numofanimations, "gimhed05.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].die[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "gimhed06.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;
  }
  ...
  if (animation[count2].loaded == 2)
  {
    ...
    animation[count2].stand[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "frkhed01.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].walk[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "frkhed02.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].attack[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "frkhed03.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].stand[1] = numofanimations;
    loadtexturetga_anim(numofanimations, "frkhed05.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;

    animation[count2].die[0] = numofanimations;
    loadtexturetga_anim(numofanimations, "frkhed06.tga", 0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
    numofanimations++;
  }
