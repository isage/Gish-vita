...
void versusmodemenu(int versusnum)
{
  ...
  while (!menuitem[0].active && !windowinfo.shutdown)
  {
    ...
    // Is item clicked?
    if (!(menuitem[1].active || menuitem[2].active || menuitem[3].active || menuitem[4].active || menuitem[5].active
          || menuitem[6].active))
      continue;
    ...
    if (!cache_fix)
    {
      ...
      {
        case 0:
          gametypeName = is4Player ? "4bath" : "bathhouse";
          break;
        case 1:
          gametypeName = is4Player ? "4field" : "field";
          break;
        case 2:
          gametypeName = "amber";
          break;
    ...
    else
    {
      ...
      {
        case 0:
          gametypeName = is4Player ? "4sumo" : "2sumo";
          break;
        case 1:
          gametypeName = is4Player ? "4football" : "2football";
          break;
        case 2:
          gametypeName = "2greed";
          break;
        case 3:
          ...
          break;
        case 4:
          gametypeName = "2dragster";
          break;
        case 5:
          gametypeName = "2collection";
          break;
        case 6:
          gametypeName = "2racing";
          break;
      }
    }
    ...
    if (menuitem[1].active)
      if (cache_fix)
        ...
        ;
    else if (menuitem[2].active)
      strcat(filename, "2");
    else if (menuitem[3].active)
      strcat(filename, "3");
    else if (menuitem[4].active)
      strcat(filename, "4");
    // 4 player.
    else if (menuitem[5].active)
      if (cache_fix)
        strcat(filename, "1");
      else
        ;
    else if (menuitem[6].active)
      strcat(filename, "2");
    strcat(filename, ".lvl");
