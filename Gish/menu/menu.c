    ...
    if (numofmenuitems > 0)
    {
      ...
      if (menuitem[joymenunum].highlight != 0)
      {
        ...
        if (control[0].joysticknum != -1)
          if (control[0].button[8] != -1)
            if (joystick[control[0].joysticknum].button[control[0].button[8]]
                && !prevjoystick[control[0].joysticknum].button[control[0].button[8]])
              menuitem[joymenunum].active = 1;
      }
      ...
      if (control[0].joysticknum != -1)
      {
        ...
        if (control[0].button[2] != -1)
          if (joystick[control[0].joysticknum].button[control[0].button[2]]
              && !prevjoystick[control[0].joysticknum].button[control[0].button[2]])
            count2 = 1;
        if (control[0].button[3] != -1)
          if (joystick[control[0].joysticknum].button[control[0].button[3]]
              && !prevjoystick[control[0].joysticknum].button[control[0].button[3]])
            count2 = -1;
      }
    ...
    if (menuitem[count].texturenum == -1)
    {
      ...
      if (menuitem[count].background == 1)
        for (count2 = 0; count2 < menuitem[count].sizex; count2++)
          drawtext("", menuitem[count].x + count2 * menuitem[count].textsize, menuitem[count].y,
                   menuitem[count].textsize, 0.125f, 0.125f, 0.125f, 1.0f);
      ...
      if (menuitem[count].highlight != 0)
      {
        while (count2 < menuitem[count].sizex && menuitem[count].label[count2] != 0
               && keyboardlabel[menuitem[count].hotkey][0] != labelascii)
        {
          ...
          if (keyboardlabel[menuitem[count].hotkey][0] == labelascii && keyboardlabel[menuitem[count].hotkey][1] == 0)
            drawtext("/c", menuitem[count].x + count2 * menuitem[count].textsize, menuitem[count].y,
                     menuitem[count].textsize, menuitem[count].r, menuitem[count].g, menuitem[count].b, 1.0f,
                     menuitem[count].label[count2]);
          else
            drawtext("/c", menuitem[count].x + count2 * menuitem[count].textsize, menuitem[count].y,
                     menuitem[count].textsize, (float)(menuitem[count].r * (menuitem[count].highlight + 1)) / 4,
                     (float)(menuitem[count].g * (menuitem[count].highlight + 1)) / 4,
                     (float)(menuitem[count].b * (menuitem[count].highlight + 1)) / 4, 1.0f,
                     menuitem[count].label[count2]);
      ...
      while (count2 < menuitem[count].sizex && menuitem[count].label[count2] != 0)
      {
        drawtext("/c", menuitem[count].x + count2 * menuitem[count].textsize, menuitem[count].y,
                 menuitem[count].textsize, (float)(menuitem[count].r * (menuitem[count].highlight + 1)) / 4,
                 (float)(menuitem[count].g * (menuitem[count].highlight + 1)) / 4,
                 (float)(menuitem[count].b * (menuitem[count].highlight + 1)) / 4, 1.0f, menuitem[count].label[count2]);
        count2++;
      }
      ...
      if (menuitem[count].type == 1)
      {
        ...
        for (count2 = 0; count2 < menuitem[count].sizex; count2++)
          drawtext("", menuitem[count].x + xoffset + count2 * menuitem[count].textsize, menuitem[count].y + yoffset,
                   menuitem[count].textsize, (float)(menuitem[count].r * (menuitem[count].highlight + 1)) / 32,
                   (float)(menuitem[count].g * (menuitem[count].highlight + 1)) / 32,
                   (float)(menuitem[count].b * (menuitem[count].highlight + 1)) / 32, 1.0f);
        ...
        if (!menuitem[count].active)
        {
          ...
          drawtext(menuinputtemp, menuitem[count].x + xoffset, menuitem[count].y + yoffset, menuitem[count].textsize,
                   (float)(menuitem[count].r * (menuitem[count].highlight + 1)) * 0.25f,
                   (float)(menuitem[count].g * (menuitem[count].highlight + 1)) * 0.25f,
                   (float)(menuitem[count].b * (menuitem[count].highlight + 1)) * 0.25f, 1.0f);
        }
        else
        {
          drawtext(menuinput, menuitem[count].x + xoffset, menuitem[count].y + yoffset, menuitem[count].textsize,
                   (float)(menuitem[count].r * (menuitem[count].highlight + 1)) * 0.25f,
                   (float)(menuitem[count].g * (menuitem[count].highlight + 1)) * 0.25f,
                   (float)(menuitem[count].b * (menuitem[count].highlight + 1)) * 0.25f, 1.0f);
          for (count2 = 0; count2 < menuitem[count].sizex; count2++)
            if ((count2 >= menuinputselectpos && count2 < menuinputcursorpos)
              ...
              drawtext("", menuitem[count].x + xoffset + count2 * menuitem[count].textsize,
                       menuitem[count].y + yoffset, menuitem[count].textsize,
                       (float)(menuitem[count].r * (menuitem[count].highlight + 1)) * 0.25f,
                       (float)(menuitem[count].g * (menuitem[count].highlight + 1)) * 0.25f,
                       (float)(menuitem[count].b * (menuitem[count].highlight + 1)) * 0.25f, 0.5f);

          if (!menuinputinsert)
            drawtext("_", menuitem[count].x + xoffset + menuinputcursorpos * menuitem[count].textsize,
                     menuitem[count].y + yoffset, menuitem[count].textsize,
                     (float)(menuitem[count].r * (menuitem[count].highlight + 1)) * 0.25f,
                     (float)(menuitem[count].g * (menuitem[count].highlight + 1)) * 0.25f,
                     (float)(menuitem[count].b * (menuitem[count].highlight + 1)) * 0.25f, 1.0f);
          else
            drawtext("", menuitem[count].x + xoffset + menuinputcursorpos * menuitem[count].textsize,
                     menuitem[count].y + yoffset, menuitem[count].textsize,
                     (float)(menuitem[count].r * (menuitem[count].highlight + 1)) * 0.25f,
                     (float)(menuitem[count].g * (menuitem[count].highlight + 1)) * 0.25f,
                     (float)(menuitem[count].b * (menuitem[count].highlight + 1)) * 0.25f, 0.5f);
...
{
  strcpy(keyboardlabel[SCAN_A], "\x84");
  strcpy(keyboardlabel[SCAN_B], "B");
  strcpy(keyboardlabel[SCAN_C], "C");
  strcpy(keyboardlabel[SCAN_D], "\x86");
  ...
  strcpy(keyboardlabel[SCAN_S], "\x85");
...
#endif
  strcpy(keyboardlabel[SCAN_SPACE], "\x87");
