...
void particlecollisionlevel(int particlenum)
{
  ...
  while (count < 10
         && lineintersectlevel(intersectpoint, normal, &scaletemp, particle[particlenum].prevposition,
                               particle[particlenum].position))
  {
    ...
    if (dotproduct(particle[particlenum].velocity, normal) < 0.0f)
    {
      ...
      scaleaddvectors(particle[particlenum].velocity, particle[particlenum].velocity, vec,
                      -particle[particlenum].elasticity);
      ...
      scaleaddvectors(particle[particlenum].position, particle[particlenum].prevposition,
                      particle[particlenum].velocity, scale);
    }
    else
    {
      copyvector(particle[particlenum].prevposition, particle[particlenum].position);
...
{
  scaleaddvectors(particle[particlenum].velocity, particle[particlenum].velocity, force,
                  1.0f / particle[particlenum].mass);
}
