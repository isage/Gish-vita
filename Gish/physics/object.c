                        ...
                        int objectnum, int *particlelist)
{
  ...
  *scale = 1.0f;
  for (count = 0; count < object[objectnum].numofcdlines; count++)
  {
    ...
    if (lineintersectline2(intersectpointtemp, normaltemp, &scaletemp, startpoint, endpoint,
                           particle[object[objectnum].particle[particlelisttemp[0]]].position,
                           particle[object[objectnum].particle[particlelisttemp[1]]].position))
      if (scaletemp < *scale)
      {
        *scale          = scaletemp;
                         ...
                         int objectnum, int *particlelist)
{
  ...
  *scale = 1.0f;
  for (count = 0; count < object[objectnum].numofcdlines; count++)
  {
    ...
    if (lineintersectline3(intersectpointtemp, normaltemp, &scaletemp, startpoint, endpoint,
                           particle[object[objectnum].particle[particlelisttemp[0]]].position,
                           particle[object[objectnum].particle[particlelisttemp[1]]].position))
      if (scaletemp < *scale)
      {
                         ...
                         int objectnum2, int *particlelist)
{
  ...
  *scale = 0.0f;
  for (count = 0; count < object[objectnum].numofcdlines; count++)
  {
    ...
    normaltemp[0] = particle[object[objectnum].particle[particlelisttemp[0]]].position[1]
                    - particle[object[objectnum].particle[particlelisttemp[1]]].position[1];
    normaltemp[1] = particle[object[objectnum].particle[particlelisttemp[1]]].position[0]
                    - particle[object[objectnum].particle[particlelisttemp[0]]].position[0];
    normaltemp[2] = 0.0f;
    ...
    if (lineintersectline2(intersectpointtemp, normaltemp, &scaletemp, vec, point,
                           particle[object[objectnum].particle[particlelisttemp[0]]].position,
                           particle[object[objectnum].particle[particlelisttemp[1]]].position))
    {
